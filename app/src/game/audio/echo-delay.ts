export function createEchoDelayEffect(audioContext: AudioContext, delayTime: number, frequency = 1100) {
	...
	return {
		apply() { wetNode.gain.setValueAtTime(0.75, audioContext.currentTime) },
		discard() { wetNode.gain.setValueAtTime(0, audioContext.currentTime) },
		isApplied() { return wetNode.gain.value > 0 },
